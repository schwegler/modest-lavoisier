...
test.describe('Native Nodes Web App Tests', () => {
  ...
  test('should load welcome card and enter sandbox mode', async ({ page }) => {
    ...
    await expect(page.locator('#previewContent h1:not(.print-title)')).toContainText('Welcome to Native Nodes!');
  });
  ...
  test('should support note editing, previewing, and autosaving', async ({ page }) => {
    ...
    await expect(page.locator('#previewContent h1:not(.print-title)')).toHaveText('Sandbox Custom Note');
  });
